...
$stats['total_comments'] = $db->query("SELECT COUNT(*) as c FROM comments")->fetch_assoc()['c'];
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between pb-2 border-b border-gray-200">
                                    ...
                                    <span class="font-bold text-gray-900"><?php echo formatNumber($stats['total_comments']); ?></span>
                                </div>
                                <div class="flex items-center justify-between pb-2 border-b border-gray-200">
                        ...
                        <div class="bg-gradient-to-br from-purple-600 to-purple-900 text-white rounded-xl shadow-lg p-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <a href="articles/create.php" class="block w-full py-2 px-4 bg-white/20 hover:bg-white/30 rounded-lg text-center font-semibold transition">
                                    ➕ Buat Berita
                                </a>
